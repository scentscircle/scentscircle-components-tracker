    ...
    <div style={{ fontFamily:"'Poppins',sans-serif", background:"#050400", minHeight:"100vh", width:"100%", color:"#f0e6c0" }}>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        th{color:#c9a84c !important;font-size:10px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;padding:8px 10px;text-align:left;white-space:nowrap}
        td{padding:8px 10px;font-size:11px;border-bottom:1px solid #2a2000;color:#f0e6c0}
      ...
      {/* HEADER */}
      <div style={{ background:"linear-gradient(135deg,#0a0800,#1a1400,#0a0800)", borderBottom:"2px solid #c9a84c", padding:"8px 16px", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:8 }}>
        <div style={{ display:"flex", alignItems:"center", gap:14 }}>
          ...
          <div>
            <div style={{ fontSize:15, fontWeight:800, background:"linear-gradient(135deg,#f5d060,#c9a84c,#f5d060)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", letterSpacing:2, textTransform:"uppercase" }}>Scentscircle Warehouse Stock</div>
        ...
        <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", gap:6 }}>
          ...
          <div style={{ display:"flex", gap:6, alignItems:"center" }}>
            ...
            {lastRefreshStr && <span style={{ fontSize:10, color:"#7a6a30" }}>· {lastRefreshStr}</span>}
          </div>
        </div>
      </div>
                    ...
                    {paginatedLogs.map((l,i) => {
                      ...
                      return (
                        <tr key={l.id||i}>
                          ...
                          <td style={{ color:"#a78bfa", fontSize:11 }}>{l.technician||"—"}</td>
